...
/**
 * @extends ServiceEntityRepository<PageAbout>
 *
...
class PageAboutRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(PageAbout $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(PageAbout $entity, bool $flush = true): void
    {
